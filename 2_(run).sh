...
docker run --name user_content_full -d -u $DOCKER_UID -v /dat/userContentdata:/bitnami/userContentdata -v /dat/static:/nodeApp/static --restart=always -p 18020:18020 -p 18019:18019 user_content_full:20211117 --pa 18019 --pw 18020 --pd 18036 -t 180 --aaocr http://www.userContentsoft.net:13019/ocr --adocr http://www.userContentsoft.net:13008 --allcore 0 --baseurl http://www.userContentsoft.net:13310
# nvidia-docker run --name user_content_full -d -u $DOCKER_UID -v /dat/mariadb:/bitnami/mariadb -v /dat/static:/nodeApp/server/uploads --restart=always -p 18020:18020 -p 18019:18019 user_content_full:20211117 --pa 18019 --pw 18020 --pd 18036 -t 180 --hana false --aaocr http://www.userContentsoft.net:13019/ocr
#docker run --name user_content --restart=always -e JAVA_OPTS="-Djava.awt.headless=true -Djava.net.preferIPv4Stack=true" -p 18019:18019 -p 18020:18020 user_content:20211117
