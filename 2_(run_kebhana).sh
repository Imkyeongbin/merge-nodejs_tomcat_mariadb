...
docker run --name userContentsagent_webui_hana -d -u $DOCKER_UID -v /dat/hana/userContentsdata:/userContentsdata -v /dat/hana/static:/nodeApp/static --restart=always -p 8020:8020 -p 8019:8019 userContentsagent_webui_hana:20220419 --pa 8019 --pw 8020 --pd 8036 -t 180 --aaocr http://cloudocr.userContentssoft.net:13019/ocr --hana true --adocr http://cloudocr.userContentssoft.net:13008 --allcore 0 --baseurl http://cloudocr.userContentssoft.net:13310
