...
docker build -t user_content_full:20211117 .
docker run --name user_content_full -d -u $DOCKER_UID -v /dat/userContentdata:/userContentdata -v /dat/static:/nodeApp/static --restart=always -p 18020:18020 -p 18019:18019 user_content_full:20211117 --pa 18019 --pw 18020 --pd 18036 -t 180 --aaocr http://www.userContentsoft.net:13019/ocr --adocr http://www.userContentsoft.net:13008 --allcore 0 --baseurl http://www.userContentsoft.net:13310
# docker run --name user_content_full -d -u $DOCKER_UID -v /dat/mariadb:/bitnami/mariadb -v /dat/uploads:/nodeApp/server/uploads --restart=always -p 18020:18020 -p 18019:18019 user_content_full:20211117 --pa 18019 --pw 18020 --pd 18036 -t 180 --hana false --aaocr http://www.userContentsoft.net:13019/ocr
# docker run --name user_content_full --restart=always --net=host user_content_full:20211117
# docker run --name user_content   --restart=always --net=host user_content:20211117 --pa 11111 --pw 22222 --pd 33333 -t 180 --a_ocr http://127.0.0.1:18019/ocr
