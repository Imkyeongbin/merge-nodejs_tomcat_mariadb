...
docker build -t user_content_full:20211125 .
docker run --name user_content_full -d -u $DOCKER_UID -v /dat/userContentdata:/userContentdata -v /dat/static:/nodeApp/static --restart=always -p 18020:18020 -p 18019:18019 user_content_full:20211125 --pa 18019 --pw 18020 --pd 18036 -t 180 --aaocr http://www.userContentsoft.net:13019/ocr --adocr http://www.userContentsoft.net:13008 --allcore 0 --baseurl http://www.userContentsoft.net:13310
